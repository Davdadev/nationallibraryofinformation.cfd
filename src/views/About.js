  ...
  return `
    ...
    <section class="section" style="padding-top:0">
      <div class="grid cols-3" style="margin-top:0">
        ${[
          ["Contact us", "Send an enquiry to the archive team."],
          ["Partners", "Institutions and collaborators we work with."],
          ["Careers", "Current vacancies and how to apply."]
        ].map(([t, x]) => card(t, x, `#/${t.toLowerCase().replace(/ /g, "")}`)).join("")}
      </div>
    </section>
  `;
}
